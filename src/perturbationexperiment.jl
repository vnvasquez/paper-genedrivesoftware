...
prob_PERT = create_decision_model(node_PERT, tspan; 
    node_strategy = mystrategy, 
    species = AedesAegypti, 
    optimizer = i) 

soldec4 = solve_decision_model3(prob_PERT, 
    TargetPercentageByDate; wildtype=wild_gene,
...
releases2 = Release(node_PERT, species, Male, 3, times, values);                                                  
